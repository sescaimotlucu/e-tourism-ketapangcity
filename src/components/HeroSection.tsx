        ...
        <div className="max-w-6xl">
          <div className="animate-fade-in-up">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-poppins font-bold mb-6 leading-tight tracking-wide">
              <span className="bg-gradient-to-r from-white via-golden-beige to-white bg-clip-text text-transparent drop-shadow-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
            <Button 
              size="lg" 
              className="bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 hover:from-emerald-500 hover:via-teal-500 hover:to-cyan-500 text-white px-10 py-6 text-lg font-poppins font-semibold rounded-2xl shadow-2xl transition-all duration-500 transform hover:scale-105 hover:shadow-emerald-500/30 border-0 group"
            >
            ...
            <Button 
              variant="outline" 
              size="lg"
              className="border-2 border-white/30 bg-white/10 backdrop-blur-md text-white hover:bg-white hover:text-neutral-800 px-10 py-6 text-lg font-poppins font-semibold rounded-2xl shadow-2xl transition-all duration-500 transform hover:scale-105 hover:shadow-white/20 group"
            >
              Learn More
